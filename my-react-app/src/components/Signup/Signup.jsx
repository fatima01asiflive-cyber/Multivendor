...
// Switched to a more stable sub-library set to prevent silent import drops
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <div className="mt-1 relative rounded-md">
                ...
                >
                  {/* Updated Icon components to match Fa6 declarations */}
                  {visible ? <FaRegEye size={22} /> : <FaRegEyeSlash size={22} />}
                </button>
              </div>
            </div>
